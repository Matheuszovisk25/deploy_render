...
class Settings(BaseSettings):
    ...
    DB_URL: str = "postgresql+asyncpg://db_certo:xLkY0nQ26QTGvEUA2nGsw98rWrgeMETB@dpg-d3i88k2dbo4c73fgrf3g-a.oregon-postgres.render.com/db_certo_gddh?ssl=require"
